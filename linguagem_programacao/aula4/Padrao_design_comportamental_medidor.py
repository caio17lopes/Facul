...
Util quando você tem varios componentes que precisam  se comunicar entre si de forma desacoplada 
Gerencia as interações entre os componentes, promovendo a baixa dependencia 
'''
