...
Decorators 
    ...
    São utilizados para modificar ou estender a funcionalidade de funções ou classes sem precisar alterar seu codigo interno 
    Os decoreators sçao implementados usadno a sintaxe do @ 
    Exixtem dois tipos de docorators em python 
        Decorators de funcão:
            São aplicados a funções individuais e permitem adicionar funcionalidades extrsaa antes, depois ou ao redor da função decorada 
        Decorators de classe
            São aplicados a classes inteiras e prmitem modificar ou estender o comportamento da classse 
'''
# # ---------------------------------------------------------------------------------------------------------------------
# Tema 2 part1
