...
Design pattern Adpater
    ...
    Padrão de projeto estrutural que permite a colaboração entre objetos com interfaces incompativeis
    Em vez de modificar o codigo existente, podemos usar o padrão Adpater para criar uma classe intermediaria que atua como um 
        adpatador entre o cliente e a classe existente
'''
