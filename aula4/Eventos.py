...
'''
Eventos de teclado 
    Para fazer interrupções de teclado em pyhton, utiliza-se a biblioteca keyboard 
    Esta requer permissão de acesso ao teclado, o que pode variar denpendendo do SO 
    Para criar eventos de timer em python sem bloquear a execução do programa, uma alternativa é usar a biblioteca sched
    Fornece recursos para agendar e executar funções em momentos especificos ou após determinados intervalos de tempo 
